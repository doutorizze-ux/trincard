    ...
    <div className="min-h-screen bg-[#050505] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden font-outfit">
      ...
      <div className="max-w-md w-full space-y-8 relative z-10">
        ...
        <div className="text-center">
          <Link to="/" className="inline-flex items-center space-x-2 text-gray-500 hover:text-[#BFFF00] transition-colors mb-8 group font-bold uppercase tracking-widest text-xs">
            <ArrowLeft className="h-4 w-4 transform group-hover:-translate-x-1 transition-transform" />
            <span>Voltar ao início</span>
          </Link>

          <div className="flex justify-center mb-8">
            <div className="w-20 h-20 bg-[#BFFF00] rounded-3xl flex items-center justify-center shadow-[0_0_30px_rgba(191,255,0,0.3)] transform -rotate-12">
          ...
          <h2 className="text-4xl lg:text-5xl font-black text-white italic tracking-tighter uppercase leading-none mb-3">
            BEM-VINDO<br /><span className="text-[#BFFF00]">DE VOLTA</span>
          </h2>
        ...
        <div className="bg-zinc-900/50 backdrop-blur-xl border border-white/5 rounded-[40px] p-8 lg:p-10 shadow-3xl">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`block w-full pl-12 pr-12 py-4 bg-black border border-white/10 text-white rounded-2xl focus:outline-none focus:ring-2 focus:ring-[#BFFF00] focus:border-transparent transition-all font-bold placeholder:text-gray-800 ${errors.password ? 'border-red-500/50 bg-red-500/5' : ''
                    }`}
                  placeholder="••••••••"
                />
                <button
                ...
                >
                  {showPassword ? (
                    <EyeOff className="h-5 w-5 text-gray-600 hover:text-[#BFFF00]" />
                  ) : (
                    <Eye className="h-5 w-5 text-gray-600 hover:text-[#BFFF00]" />
                  )}
                </button>
              </div>
              {errors.password && (
            ...
            <div className="flex items-center justify-between px-1">
              <div className="flex items-center">
                <input
                  ...
                  name="remember-me"
                  type="checkbox"
                  className="h-4 w-4 bg-black border-white/10 text-[#BFFF00] focus:ring-[#BFFF00] rounded"
                />
              ...
              <div className="text-sm">
                <a href="#" className="font-bold text-[#BFFF00] hover:text-white transition-colors uppercase tracking-widest">
                  Perdeu a senha?
                </a>
              </div>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex justify-center items-center space-x-3 py-5 px-6 rounded-2xl text-base font-black italic uppercase tracking-[0.1em] text-black bg-[#BFFF00] hover:bg-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#BFFF00] disabled:opacity-50 disabled:cursor-not-allowed transition-all transform active:scale-95 shadow-xl shadow-[#BFFF00]/10"
            >
              {loading ? (
                <>
